...
function getStrength(pwd) {
  ...
  if (score <= 3) return { score, label: 'Fair',   color: '#D4750C' }
    ...
    <div className="min-h-screen w-full flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-[55%] flex-col justify-between px-16 xl:px-24 py-14 border-r border-gray-100">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-lg -mt-8">
          <h1 className="text-[3.5rem] font-semibold text-gray-900 leading-[1.08] tracking-tight mb-5">
            Your spending story<br />starts here.
          </h1>
      ...
      <div className="flex-1 flex items-center justify-center px-8 sm:px-12 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 tracking-tight mb-1">Create account</h2>
            <p className="text-sm text-gray-400">Start tracking your spending</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-400">
            ...
            <Link to="/login" className="font-semibold transition-colors" style={{ color: '#150A02' }}>
              Sign in
            </Link>
          </p>
        </div>
